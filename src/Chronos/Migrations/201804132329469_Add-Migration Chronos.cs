namespace Chronos.Migrations
{
    ...
    public partial class AddMigrationChronos : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            CreateIndex("dbo.TodoItems", "GroupId");
            AddForeignKey("dbo.TodoItems", "GroupId", "dbo.Groups", "Id", cascadeDelete: true);
        }
    }
}
